...
const NavigationBar = () => {
	return (
		<nav className="navigation-bar">
			<NavLink to="/datavisualization" id="dataforge-logo-container" end className={({ isActive }) => isActive ? "active-link" : ""}><img src="/images/dataforgelogo.png" alt="dataforge logo" id="dataforge-logo"></img><h2 id="dataforge-title">DataForge</h2></NavLink>
